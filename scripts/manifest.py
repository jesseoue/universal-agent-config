...
ADAPTERS = {
    ...
    "cursor": [
        ".cursorignore",
        ".cursor/mcp.json",
        ".cursor/rules/00-universal-agent-core.mdc",
        ".cursor/rules/01-model-routing.mdc",
        ".cursor/rules/02-planning.mdc",
        ".cursor/rules/03-testing.mdc",
        ".cursor/rules/04-typescript.mdc",
        ".cursor/rules/05-python.mdc",
        ".cursor/rules/06-documentation.mdc",
        ".cursor/rules/07-security-review.mdc",
    ],
